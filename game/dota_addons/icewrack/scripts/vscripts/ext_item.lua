...
local stExtItemTypeEnum =
{
	...
	IW_ITEM_TYPE_WEAPON_THROWN = 9,    IW_ITEM_TYPE_WEAPON_AMMO = 10,     IW_ITEM_TYPE_ARMOR_MAIL = 11,      IW_ITEM_TYPE_ARMOR_LEATHER = 12,
	IW_ITEM_TYPE_ARMOR_CLOTH = 13,     IW_ITEM_TYPE_ARMOR_HEAD = 14,      IW_ITEM_TYPE_ARMOR_BODY = 15,      IW_ITEM_TYPE_ARMOR_HANDS = 16,
	IW_ITEM_TYPE_ARMOR_FEET = 17,      IW_ITEM_TYPE_ARMOR_WAIST = 18,     IW_ITEM_TYPE_ARMOR_SHIELD = 19,    IW_ITEM_TYPE_JEWELRY_AMULET = 20,
	IW_ITEM_TYPE_JEWELRY_RING = 21,    IW_ITEM_TYPE_USEABLE_POTION = 22,  IW_ITEM_TYPE_USEABLE_ELIXIR = 23,  IW_ITEM_TYPE_USEABLE_WAND = 24,
	IW_ITEM_TYPE_USEABLE_RECIPE = 25,  IW_ITEM_TYPE_USEABLE_BOOK = 26,    IW_ITEM_TYPE_REAGENT_HERB = 27,    IW_ITEM_TYPE_REAGENT_METAL = 28,
...
local stExtItemFlagEnum =
{
	...
	IW_ITEM_FLAG_USES_AMMO = 128,
	IW_ITEM_FLAG_CAN_ACTIVATE = 256,
	IW_ITEM_FLAG_CAN_READ = 512,
}
