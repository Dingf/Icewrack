...
{
	IW_ABILITY_SKILL_FIRE = 1,       IW_ABILITY_SKILL_EARTH = 2,      IW_ABILITY_SKILL_WATER = 3,      IW_ABILITY_SKILL_AIR = 4,
	IW_ABILITY_SKILL_LIGHT = 5,      IW_ABILITY_SKILL_SHADOW = 6,     IW_ABILITY_SKILL_BODY = 7,       IW_ABILITY_SKILL_MIND = 8,      
	IW_ABILITY_SKILL_CREATE = 9,     IW_ABILITY_SKILL_DESTROY = 10,   IW_ABILITY_SKILL_ALTER = 11,     IW_ABILITY_SKILL_META = 12,
	IW_ABILITY_SKILL_SHAPE = 13,     IW_ABILITY_SKILL_TWOHAND = 14,   IW_ABILITY_SKILL_ONEHAND = 15,   IW_ABILITY_SKILL_MARKSMAN = 16,
	IW_ABILITY_SKILL_PROTECT = 17,   IW_ABILITY_SKILL_EVASION = 18,   IW_ABILITY_SKILL_LEADER = 19,    IW_ABILITY_SKILL_LOCKPICK = 20,
	IW_ABILITY_SKILL_FIRST_AID = 21, IW_ABILITY_SKILL_HERBALISM = 22, IW_ABILITY_SKILL_SMITHING = 23,  IW_ABILITY_SKILL_LEATHER = 24,
	IW_ABILITY_SKILL_WOOD = 25,      IW_ABILITY_SKILL_TAILORING = 26,
}

for k,v in pairs(stExtAbilityFlagEnum) do _G[k] = v end
for k,v in pairs(stExtAbilitySkillEnum) do _G[k] = v end
