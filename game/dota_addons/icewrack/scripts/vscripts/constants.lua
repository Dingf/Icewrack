...
stExtModifierEventValues =
{
	...
	IW_MODIFIER_EVENT_ON_DEAL_ATTACK_DAMAGE = 7,
	IW_MODIFIER_EVENT_ON_TAKE_ATTACK_DAMAGE = 8,
	IW_MODIFIER_EVENT_ON_DODGE_ATTACK = 9,
	IW_MODIFIER_EVENT_ON_ATTACK_START = 10,
	IW_MODIFIER_EVENT_ON_PRE_ATTACK = 11,
}
...
stExtModifierEventAliases =
{
	...
	[IW_MODIFIER_EVENT_ON_DEAL_ATTACK_DAMAGE] = "OnDealAttackDamage",
	[IW_MODIFIER_EVENT_ON_TAKE_ATTACK_DAMAGE] = "OnTakeAttackDamage",
	[IW_MODIFIER_EVENT_ON_DODGE_ATTACK] = "OnDodgeAttackEvent",
	[IW_MODIFIER_EVENT_ON_ATTACK_START] = "OnAttackEventStart",
	[IW_MODIFIER_EVENT_ON_PRE_ATTACK] = "OnPreAttackEvent",
}
